...
<div className="wave"></div>
        ...
        return <div key={book.id} className={`text-lg flex justify-center sm:justify-between items-center  flex-wrap md:flex-nowrap  py-2 px-4 rounded-md gap-4 mb-4 font-medium bg-white bg-opacity-70`}>
            <p className='mb-0 w-full md:w-3/4'>{book.title}</p>
