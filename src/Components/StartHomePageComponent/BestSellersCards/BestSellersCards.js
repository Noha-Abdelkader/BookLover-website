      ...
      <div className="px-5 py-16 bg-orange-50">
        ...
        <div className="flex flex-wrap items-start justify-center p-4 ">
          ...
          {isLoading ? <div className="center">
            ...
            </div> : books ? books.map(book =>  <div  key={book.id}  className="w-1/3 md:w-1/4 lg:w-1/6 p-4 " >
             ...
             <div className="bg-orange-50 text-center rounded-md">
               ...
               <img
                 src="httpsimg.freepik.com/free-vector/focused-tiny-people-reading-books_74855-5836.jpg"
